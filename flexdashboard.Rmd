...
Here is an overview of the data set. You can see the number of articles by several different variables.
...
Keywords were chosen from several resources, including Library of Congress' [Chronicling America Race and Ethnicity Keyword Thesaurus](https://edsitement.neh.gov/media-resources/race-and-ethnicity-keyword-thesaurus-chronicling-america).
...
renderDataTable({
  selected_keywords <- as.character(unlist(AAPI_keywords$word))
  bigrams <- ngrams_sep |>
      select(as_date, word1, word2) |>
      filter(word1 %in% selected_keywords | word2 %in% selected_keywords)
