...
Sidebar {.sidebar}
-------------------------------------
The Bing Sentiment Lexicon ranges from -1 to 1, with -1 being the most negative and 1 being the most positive. The Afinn Sentiment Lexicon ranges from -5 to 5, with -5 being the most negative and 5 being the most positive. The NRC Sentiment Lexicon categorizes words into different emotions (Anger, Anticipation, Disgust, Fear, Joy, Negative, Sadness, Surprise, Trust).
