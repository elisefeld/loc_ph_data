...
pearl_data <- prepare_data("pearl_data.rds")

download.file("https://raw.githubusercontent.com/elisefeld/loc_ph_data/main/Data/Years/data_1941.rds",
  destfile = "data_1941.rds")

download.file("https://raw.githubusercontent.com/elisefeld/loc_ph_data/main/Data/Years/data_1942.rds",
  destfile = "data_1942.rds")

data1941 <- readRDS("data_1941.rds")
data1942 <- readRDS("data_1942.rds")

data_clean <- bind_rows(data1941,
                        data1942) |>
  select(index,
         date,
         title,
...
output$filter_ui <- renderUI({
  tagList(
    pickerInput(
      ...
      choices = unique(pearl_data$state),
    ...
    sliderInput(
      "date_filter",
      "Date Range:",
      min = as.Date(min(pearl_data$as_date, na.rm = TRUE)),
      max = as.Date(max(pearl_data$as_date, na.rm = TRUE)),
      value = range(pearl_data$as_date, na.rm = TRUE)
    )
  )
})
```
