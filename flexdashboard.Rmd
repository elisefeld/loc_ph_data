...
```{r}
pearl_data |>
  filter(!is.na(other_language)) |>
  count(other_language, sort = TRUE) |>
...
pearl_data |>
  filter(!is.na(other_language)) |>
  count(other_language, state, sort = TRUE) |>
  filter(other_language != "NA") |>
  ggplot(aes(reorder(other_language, n), n), fill = other_language) +
  geom_col() +
  coord_flip() +
...
pearl_data |>
  ...
  count(subject_ethnicity, sort = TRUE) |>
...
```{r}
pearl_data |>
  count(newspaper_name, sort = TRUE) |>
  slice_head(n = 25) |>
  ggplot(aes(factor(reorder(newspaper_name, n)), n)) +
  geom_col() +
  coord_flip() +
...
```{r}
keywords |>
  filter(id == "aapi_keywords") |>
  count(word, before_pearl_harbor, sort = TRUE) |>
  ggplot(aes(reorder(word, n), n)) +
  geom_col() +
  coord_flip() +
  labs(title = "Asian American Pacific Islander Keywords \n in Front Pages of Newspapers",
       subtitle = "September 7th, 1941 to March 7th, 1942",
       x = "Count",
       y = "Keyword") +
  theme_minimal() +
...
```{r}
keywords |>
  filter(id == "german_keywords") |>
  count(word, before_pearl_harbor, sort = TRUE) |>
  ggplot(aes(reorder(word, n), n)) +
  geom_col() +
  coord_flip() +
  labs(title = "German Keywords in Front Pages of Newspapers",
       subtitle = "September 7th, 1941 to March 7th, 1942",
       x = "Count",
       y = "Keyword") +
  theme_minimal() +
...
```{r}
keywords |>
  filter(id == "jewish_keywords") |>
  count(word, before_pearl_harbor, sort = TRUE) |>
  ggplot(aes(reorder(word, n), n)) +
  geom_col() +
  coord_flip() +
  labs(title = "Jewish Keywords in Front Pages of Newspapers",
       subtitle = "September 7th, 1941 to March 7th, 1942",
       x = "Count",
       y = "Keyword") +
  theme_minimal() +
...
```{r}
keywords |>
  filter(id == "misc_keywords") |>
  count(word, before_pearl_harbor, sort = TRUE) |>
  ggplot(aes(reorder(word, n), n)) +
  geom_col() +
  coord_flip() +
  labs(title = "Miscellaneous Keywords in Front Pages of Newspapers",
       subtitle = "September 7th, 1941 to March 7th, 1942",
       x = "Count",
       y = "Keyword") +
  theme_minimal() +
